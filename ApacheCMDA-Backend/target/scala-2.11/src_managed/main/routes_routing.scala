...
// @HASH:89caf1743a34d5376b806c4dd1580ffa6f214aaf
// @DATE:Thu Dec 03 18:39:07 PST 2015
...
// @LINE:95
private[this] lazy val controllers_SearchController_searchUsingCriteria61_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("search/user/criteria"))))
private[this] lazy val controllers_SearchController_searchUsingCriteria61_invoker = createInvoker(
...
// @LINE:96
private[this] lazy val controllers_SearchController_searchUserFuzzy62_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("search/user/fuzzy/"),DynamicPart("partial", """[^/]+""",true))))
private[this] lazy val controllers_SearchController_searchUserFuzzy62_invoker = createInvoker(
...
// @LINE:97
private[this] lazy val controllers_SearchController_searchPostContentByKeyword63_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("search/post/"),DynamicPart("keyword", """[^/]+""",true))))
private[this] lazy val controllers_SearchController_searchPostContentByKeyword63_invoker = createInvoker(
...
// @LINE:95
case controllers_SearchController_searchUsingCriteria61_route(params) => {
   call { 
        controllers_SearchController_searchUsingCriteria61_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.SearchController]).searchUsingCriteria())
   }
}
        

// @LINE:96
case controllers_SearchController_searchUserFuzzy62_route(params) => {
   call(params.fromPath[String]("partial", None), Param[String]("format", Right("json"))) { (partial, format) =>
        controllers_SearchController_searchUserFuzzy62_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.SearchController]).searchUserFuzzy(partial, format))
   }
}
        

// @LINE:97
case controllers_SearchController_searchPostContentByKeyword63_route(params) => {
   call(params.fromPath[String]("keyword", None), Param[String]("format", Right("json"))) { (keyword, format) =>
        controllers_SearchController_searchPostContentByKeyword63_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.SearchController]).searchPostContentByKeyword(keyword, format))
   }
}
