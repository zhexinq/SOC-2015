...
// @HASH:3b2e89b94a141f3ad5dc41991b219db87077fbd7
// @DATE:Tue Dec 01 17:19:12 PST 2015
...
// @LINE:80
private[this] lazy val controllers_ShareController_newShare52_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("share/new"))))
private[this] lazy val controllers_ShareController_newShare52_invoker = createInvoker(
...
// @LINE:81
private[this] lazy val controllers_ShareController_addSharePost53_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("share"))))
private[this] lazy val controllers_ShareController_addSharePost53_invoker = createInvoker(
...
// @LINE:82
private[this] lazy val controllers_ShareController_getSharedPostsByUserId54_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("share/user/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_ShareController_getSharedPostsByUserId54_invoker = createInvoker(
...
// @LINE:83
private[this] lazy val controllers_ShareController_deleteShareByPostId55_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("share/delete/"),DynamicPart("postId", """[^/]+""",true))))
private[this] lazy val controllers_ShareController_deleteShareByPostId55_invoker = createInvoker(
...
// @LINE:88
private[this] lazy val controllers_FollowController_getFolloweesByUserId58_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("follow/user/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_FollowController_getFolloweesByUserId58_invoker = createInvoker(
...
// @LINE:80
case controllers_ShareController_newShare52_route(params) => {
   call { 
        controllers_ShareController_newShare52_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ShareController]).newShare())
   }
}
        

// @LINE:81
case controllers_ShareController_addSharePost53_route(params) => {
   call { 
        controllers_ShareController_addSharePost53_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ShareController]).addSharePost())
   }
}
        

// @LINE:82
case controllers_ShareController_getSharedPostsByUserId54_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_ShareController_getSharedPostsByUserId54_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ShareController]).getSharedPostsByUserId(id, format))
   }
}
        

// @LINE:83
case controllers_ShareController_deleteShareByPostId55_route(params) => {
   call(params.fromPath[Long]("postId", None)) { (postId) =>
        controllers_ShareController_deleteShareByPostId55_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ShareController]).deleteShareByPostId(postId))
   }
}
...
// @LINE:88
case controllers_FollowController_getFolloweesByUserId58_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_FollowController_getFolloweesByUserId58_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.FollowController]).getFolloweesByUserId(id, format))
   }
}
